...
var Global = {
	//在线手册根目录，默认值
	rootPath: "http://www.eduppp.cn/css/",
	//是否chm浏览方式
...
(function(){
	...
	(function (){
		...
		'<div class="g-browser g-clear">'+
			'<ul>'+
				'<li><a href="" target="_blank" rel="external" class="external">Issues</a></li>'+
				'<li><a href="" target="_blank" rel="external" class="external">Pull Requests</a></li>'+
			'</ul>'+
