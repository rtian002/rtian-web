...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
var hdhtml='<header id="hd"><section id="mashead" class="g-mod"><hgroup class="sitename"><a href="./"><h1>jQuery参考手册</h1><h2>web前端开发参考手册系列</h2></a></hgroup><nav class="related"><ul class="nav"><li class="version">当前版本：jQuery-1.11.3</li><li class="resource" ><div class="g-combobox"><a href="#" class="g-transition target"><strong>网页速查</strong><span>选择其它项<!--[if lte IE 7]><ins>IE7 and earlier, Get to die</ins><![endif]--></span></a><div class="g-transition list"><ul><li><a href="/web/css">CSS3速查手册</a></li><li><a href="/web/jquery">jQuery速查手册</a></li><li><a href="/web/">MS-SQL开发手册</a></li><li><a href="/web/">PHP开发手册</a></li><li><a href="/web/">ASP开发手册</a></li></ul></div></div></li><li class="version">|<a href="/"><strong>&nbsp;&nbsp;✿主页&nbsp;&nbsp;</strong></a></li></ul></nav>	</section></header>';
var fthtml='<p id="footer">Copyright &copy; rtian</a> 2012-2015. All right reserved.</p>';
$("#left").before(hdhtml);
$("#content").append(fthtml);
$("#content").height($(window).height()-90);
$("#content").width($(window).width()-285);
